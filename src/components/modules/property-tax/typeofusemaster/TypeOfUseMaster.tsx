            ...
            <div className="flex-1 flex flex-col min-h-0">
              <CardList
                ...
                renderCard={(typeItem) => {
                  ...
                  return (
                    // <div key={typeItem.typeOfUseId} className="w-full px-2 mb-4">
                    //   <div
                    //     role="button"
                    //     tabIndex={0}
                    //     onClick={() => {
                    ...
                    //     }}
                    //     className={clsx(
                    //       "cursor-pointer select-none rounded-xl border p-3 text-left shadow-sm transition",
                    //       selected
                    ...
                    //           </span>
                    //         </div>
                    //         <div className="mt-2 text-base font-semibold text-slate-900">{typeItem.description}</div>
                    //       </div>
                    ...
                    //       <span className="text-purple-700 bg-purple-50 px-2 py-1 rounded-md border border-purple-300">
