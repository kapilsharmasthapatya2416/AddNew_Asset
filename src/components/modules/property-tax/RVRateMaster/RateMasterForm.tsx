...
const RateMasterForm: React.FC<RateMasterFormProps> = ({
  ...
  const handleDeleteRates = async () => {
    ...
    const configuredRatesCount = latestBackendRates.filter(
      rate => Number(rate.rateSquareMeter) > 0
    ).length;
  ...
  // If used in drawer mode (onClose is provided), don't show the header and close button here (Drawer provides it)
      ...
      <div className="space-y-3">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between bg-[#f8faff] border border-blue-200 rounded-xl px-2 md:px-3 py-2 gap-2 md:gap-0 shadow-md">
          <div className="flex items-center gap-2 w-full md:w-auto">
            ...
            <Tabs
              value={rateFrequency}
              onChange={value => setRateFrequency(value as "Monthly" | "Yearly")}
              variant="pills"
              size="sm"
                            ...
                            <div className="space-y-3">
                              ...
                              <div className="flex items-end gap-2">
                                ...
                                <Button
                                  ...
                                  className="h-[32px] px-2 text-xs font-semibold rounded-lg flex items-center gap-5 bg-blue-600 hover:bg-blue-700 disabled:bg-gray-300 disabled:cursor-not-allowed text-white transition-all min-w-[120px] justify-center"
                                >
                            ...
                            <div className="space-y-3">
                              ...
                              <div className="flex items-end gap-2">
                                ...
                                <Button
                                 ...
                                 className="h-[32px] ml-1.5 px-2 text-xs font-semibold rounded-lg flex items-center gap-3 bg-blue-600 hover:bg-blue-700 disabled:bg-gray-300 disabled:cursor-not-allowed text-white transition-all min-w-[120px] justify-center"
                                >
                                  <CheckCircle size={13} className="inline-block" />
                                  <span className="inline-block leading-none">{t('buttons.copyRatesNow')}</span>
                                </Button>
