...
export interface AssetFormStepConfig {
  id: number;
  key: "basic-info" | "legal-complience" | "furniture-fixture" | "valuation" | "documents";
  label: string;
  icon: LucideIcon;
  path: string;
}
...
export const ASSET_FORM_STEPS: AssetFormStepConfig[] = [
  {
    ...
    label: "Basic Info",
    icon: ClipboardList,
    path: "/asset/add-New-Asset/basic-Info",
  },
  {
    id: 2,
    ...
    icon: ShieldCheck,
    path: "/asset/add-New-Asset/legal-Complience",
  },
  {
    id: 3,
    ...
    icon: Armchair,
    path: "/asset/add-New-Asset/furniture&Fixture",
  },
  {
    id: 4,
    key: "valuation",
    ...
    path: "/asset/add-New-Asset/valuation",
  },
  {
    id: 5,
    key: "documents",
    label: "Documents",
    icon: FileText,
    path: "/asset/add-New-Asset/documents",
  },
];
