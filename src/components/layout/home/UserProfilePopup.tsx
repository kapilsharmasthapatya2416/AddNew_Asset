...
export const UserProfilePopup: React.FC<UserProfilePopupProps> = ({ isOpen, onClose }) => {
    ...
    return (
        <div className="absolute top-12 right-0 w-80 bg-white rounded-lg shadow-xl border border-gray-200 z-50 profile-dropdown-container animate-in fade-in zoom-in-95 duration-200">
            {/* Header */}
            ...
            <div className="p-4 space-y-4">
                <div className="flex items-start gap-3">
                    ...
                    <div>
                        <p className="text-[10px] text-gray-500 uppercase font-semibold">User ID</p>
                ...
                <div className="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm font-medium text-gray-900">Tax Assessment Officer</p>
                    </div>
                </div>
