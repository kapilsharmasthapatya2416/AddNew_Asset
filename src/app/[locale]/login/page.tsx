...
export default async function LoginPage({ params, searchParams }: LoginPageProps) {
    ...
    const stepStr = typeof stepRaw === 'string' ? stepRaw : Array.isArray(stepRaw) ? stepRaw[0] : undefined;
    if (stepStr === 'otp') {
    ...
    const username =
        typeof usernameRaw === 'string' ? usernameRaw : Array.isArray(usernameRaw) ? usernameRaw[0] || '' : '';
