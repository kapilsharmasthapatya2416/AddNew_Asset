...
import { ScreenFieldsMasterShell } from '@/components/modules/asset/configurationMaster/ScreenFieldsMasterShell';
import { getDefaultScreenConfigs } from '@/lib/utils/screenConfigStorage';

export default function ScreenFieldsMasterPage() {
      ...
      <div className="flex min-h-[calc(100vh-10rem)]">
        ...
        <div className="flex-1 p-6">
          <div className="mx-auto w-full max-w-7xl">
            <ScreenFieldsMasterShell initialScreenConfigs={initialScreenConfigs} />
          </div>
        </div>
      </div>
    </MainLayout>
